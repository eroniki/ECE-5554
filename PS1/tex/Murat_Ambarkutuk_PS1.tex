...
\begin{enumerate}
	...
	\begin{enumerate} 
		...
		\begin{enumerate}
			...
			\item Comparison: \\
			\includegraphics[width=\linewidth]{../matlab/outputWidthComparisonPrague.png}
		\end{enumerate}
		...
		\begin{enumerate}
			...
			\item Comparison: \\
			\includegraphics[width=\linewidth]{../matlab/outputWidthComparisonMall.png}
		\end{enumerate}
		%% add titlle and size \ldots, add subplots, change picture with the correct
		% one
		\includegraphics[width=\linewidth]{../matlab/outputWidthMall.png}
	SeamCarvingReduceWidth.m
